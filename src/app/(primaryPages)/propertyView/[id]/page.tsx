    ...
    <Container>
        {
            ...
            <div>
                <div className='flex justify-between items-center'>
                    <p className='text-[24px] font-[700] text-[#161518]'>{data?.title}</p>
            ...
            <div className='flex gap-1 w-full h-[450px]'>
                <div className='flex flex-col gap-1 w-[30%] h-full'>
                    <div className='w-full h-[50%]'><img src={data?.pictures[0].image} className='w-full h-full' alt=''/></div>
                    <div className='w-full h-[50%]'><img src={data?.pictures[1].image} className='w-full h-full' alt=''/></div>
                </div>
            ...
            <div className='flex gap-10'>
                ...
                <div className='w-3/4 space-y-6 border-t pt-8'>
                    <div>
                ...
                <div className='w-1/4 shadow-xl pt-8'>
                    <div>
