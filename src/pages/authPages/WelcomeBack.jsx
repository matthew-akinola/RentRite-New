...
const WelcomeBack = () => {
  return (
    ...
    <div className='flex justify-center items-center flex-col space-y-6 w-full h-[100vh]'>
        ...
        <h2 className='font-[700] text-[28px] leading-[36px]  text-[#79007B]'>Welcome Back</h2>
        <p className='text-[#2B2A30] font-[400] text-[16px] leading-[24px] w-[30%] text-center'>We’re excited to see you again! You will be redirected in a few seconds.</p>
