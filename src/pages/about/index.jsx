...
// import About4 from "../../images/about5.png";
        ...
        <div className="lg:grid lg:grid-cols-2 gap-16">
          <div className="items-center text-black">
            ...
            <div className="flex md:flex-wrap gap-2 md:mt-7">
              <button className="bg-[#79007B] text-white px-5 py-4 rounded-lg w-full max-w-[10rem] h-14 flex justify-center items-center" onClick={() => navigate("/user-signup")}>
                Get Started
              </button>
                <button className="px-5 py-4 bg-white shadow text-black rounded-lg w-full max-w-[10rem] h-14 flex justify-center items-center" onClick={()=> navigate("/agent-signup")}>
                  Be an Agent
                </button>
            </div>
          </div>
          <div className="static hidden lg:block pl-3">
            <img
              ...
              alt=""
            />
            <img className="image2 pt-4" src={AboutBg} alt="" />
          </div>
        </div>
      </section>
        ...
        <div className="lg:grid grid-cols-2 items-center">
          ...
          <div className="md:pl-3 lg:pl-14">
            ...
            <div className="flex flex-wrap gap-2 md:mt-4 lg:mt-7">
              <button className="bg-[#79007B] text-white px-5 py-4 rounded-lg w-full max-w-[10rem] h-14 flex justify-center items-center" onClick={()=>navigate("/rent")}>
                Rent Now
              </button>
            </div>
          </div>
